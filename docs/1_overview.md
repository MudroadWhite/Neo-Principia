...
This project aims to be a scythe to demystify a myth. This project wraps up math and philosophical ideas, written down, organized and iterates like a software. This project is a small world to communicate, between theory and application, and between math, philosophy and computer science people.

This project shows the power of type-theory-based modern formal verifiers, with only mediocre technology being used. With shallow embedding, this project sculpts a better base for others to construct. It is to be detected bugs easily, modified easily, evaluated everything with controlled automation, and maybe built on with better abstractions. It saves you the time to buy a physical copy of the book, flip the pages with anxiety and boredom, just to grind every line of proofs written in a ruthless massive tomb that appears in your dream and drags your hair into a mess every night. This project can inspire indie gamedevs whose core job is making mediocre ideas into games; the jokes of Principia Mathematica therefore continues flooding on X.
