...
> **Update**: Later, I have been asking questions on Philosophy StackExchange on confusions I have met, see [this PhilSE QA](https://philosophy.stackexchange.com/questions/139085/exact-definition-for-elementary-proposition-and-function-in-principia-mathematic/139086#139086) as a starting point, which is likely to be extended into a series of QA in the far future. Everything below are **deprecated**, but to left as an archive. If I have time I would update this chapter, but I mostly decide to leave everything here as it is.
