...
On the other hand, Rocq's *notation system* has been very useful for expressing the new symbols in each of the chapter: see chapter 14[CITATION: ch14.v], 20[CITATION: ch20.v] and beyond. 
...
**Types.** 
TODO: 
- Currently  won't type the propositions. 
- Design of type: functions are lacking the description of `->` types

### Chapter 1 - 5
**Coverage: 100%**
TODO: MP? delete this section?

### Chapter 9
**Coverage: 100%**, without informal parts

TODO: the primitive propositions with `\/` and `~`
...
**General.** TODO: use theorem variants, might have something to be done with ch12; Are the `!` functions untyped, or they come strictly with a `Predicate` type?? have to manually lift theorems to higher order
